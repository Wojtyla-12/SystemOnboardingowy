    ...
    public partial class Inicjalizacja : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Wdrozenia", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Wdrozenia_Pracownicy_PracownikId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TrescZadania = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DzialOdpowiedzialny = table.Column<int>(type: "int", nullable: false),
                    CzyWykonane = table.Column<bool>(type: "bit", nullable: false),
                    WdrozenieId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
